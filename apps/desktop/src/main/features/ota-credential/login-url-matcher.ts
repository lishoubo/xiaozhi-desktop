...
import { ctripLoginUrlMatcher } from './ota/ctrip/login-url-matcher';
import { douyinLoginUrlMatcher } from './ota/douyin/login-url-matcher';
import { meituanLoginUrlMatcher } from './ota/meituan/login-url-matcher';
