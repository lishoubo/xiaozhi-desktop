  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-[#ededed] aria-expanded:bg-secondary aria-expanded:text-secondary-foreground',
        ghost:
      ...
      size: {
        default:
          'h-9 gap-1.5 px-4 in-data-[slot=button-group]:rounded-md has-data-[icon=inline-end]:pr-3.5 has-data-[icon=inline-start]:pl-3.5',
