...
**2026-09-21｜携程侧代码完成并过 code review，8 次提交未推送。剩余全是真机验证。**

**下一步：美团接入扫描**（携程是唯一实装渠道，美团尚未踩点）。
...
⚠️ **`idleMs` 不用再改了** —— 2026-09-21 起 dev 构建默认就是 60 秒（见下方环境分档）。
...
| 9.8 | 观察一轮耗时与请求数，确认 pre/online 的 5 分钟是否合适 |
